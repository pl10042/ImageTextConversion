...
# Take language type input
print("What do you want to translate image to? ")
dest = input()

# Run translation
words = pytesseract.image_to_string(img)
result = translator.translate(words, lang_src='en', lang_tgt=dest)
...
cv2.putText(img2, result, (70, 175), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 2)
...
# cv2.imshow('Translated', imgResize2)
# cv2.imshow('Source Text', imgResize)
